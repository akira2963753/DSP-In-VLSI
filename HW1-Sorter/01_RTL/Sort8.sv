...
module Sort8 (
    ...
    CAS Stage1_1(in2, in3, 1'd0, s1_out[2], s1_out[3]);
    CAS Stage1_2(in4, in5, 1'd1, s1_out[4], s1_out[5]);
    CAS Stage1_3(in6, in7, 1'd0, s1_out[6], s1_out[7]);
    ...
    CAS Stage3_1(s2_out_reg[2], s2_out_reg[3], 1'd1, s3_out[2], s3_out[3]);
    CAS Stage3_2(s2_out_reg[4], s2_out_reg[5], 1'd0, s3_out[4], s3_out[5]);
    CAS Stage3_3(s2_out_reg[6], s2_out_reg[7], 1'd0, s3_out[6], s3_out[7]);

    // Stage 4
    CAS Stage4_0(s3_out[0], s3_out[4], 1'd1, s4_out[0], s4_out[4]);
    CAS Stage4_1(s3_out[1], s3_out[5], 1'd1, s4_out[1], s4_out[5]);
    CAS Stage4_2(s3_out[2], s3_out[6], 1'd1, s4_out[2], s4_out[6]);
    CAS Stage4_3(s3_out[3], s3_out[7], 1'd1, s4_out[3], s4_out[7]);

    // Stage 5
    CAS Stage5_0(s4_out_reg[0], s4_out_reg[2], 1'd1, s5_out[0], s5_out[2]);
    CAS Stage5_1(s4_out_reg[1], s4_out_reg[3], 1'd1, s5_out[1], s5_out[3]);
    CAS Stage5_2(s4_out_reg[4], s4_out_reg[6], 1'd1, s5_out[4], s5_out[6]);
    CAS Stage5_3(s4_out_reg[5], s4_out_reg[7], 1'd1, s5_out[5], s5_out[7]);

    // Stage 6
    CAS Stage6_0(s5_out[0], s5_out[1], 1'd1, out0, out1);
    CAS Stage6_1(s5_out[2], s5_out[3], 1'd1, out2, out3);
    CAS Stage6_2(s5_out[4], s5_out[5], 1'd1, out4, out5);
    CAS Stage6_3(s5_out[6], s5_out[7], 1'd1, out6, out7);
