...
module SelectTopK(
    ...
    output logic signed [8:0] SortOut,
    ...
    logic signed [8:0] Sort8_out [0:3];
    logic signed [8:0] Reg8_PingBuf [0:3][0:3];
    logic signed [8:0] Reg8_PongBuf [0:3][0:3];

    logic signed [8:0] Group_out [0:3];
    logic signed [8:0] Winner_out [0:1];
    logic [1:0] Winner_Group [0:1];
    logic [1:0] Final_Winner_Group;

    logic [1:0] Reg_cnt;
    logic cmp_pending;
    logic Blk_In_Reg0, Blk_In_Reg1;
