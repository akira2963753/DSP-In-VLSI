...
module Digital_Filter_Parallel (
    input   logic                           clk,
    input   logic                           rst_n,
    input   logic   signed  [`X_WIDTH-1:0]  FilterIn0,
    input   logic   signed  [`X_WIDTH-1:0]  FilterIn1,
    input   logic                           ValidIn,
    output  logic   signed  [`Y_WIDTH-1:0]  FilterOut0,
    output  logic   signed  [`Y_WIDTH-1:0]  FilterOut1,
    ...
    logic   signed  [`X_WIDTH-1:0]   X_D [0:`H_NUM + 2*`PIPE_STAGE];
    logic   signed  [`MUL_WIDTH-1:0] MUL0 [0:`H_NUM-1];
    logic   signed  [`X_WIDTH+`H_WIDTH:0] FULL_MUL0 [0:`H_NUM-1]; // Q6.28

    logic   signed  [`MUL_WIDTH-1:0] MUL1 [0:`H_NUM-1];
    logic   signed  [`X_WIDTH+`H_WIDTH:0] FULL_MUL1 [0:`H_NUM-1]; // Q6.28

    logic   signed  [`Y_WIDTH-1:0] Y_REG_IN0  [0:`PIPE_STAGE-1];
    logic   signed  [`Y_WIDTH-1:0] Y_REG_OUT0 [0:`PIPE_STAGE-1];
    logic   signed  [`Y_WIDTH-1:0] Y_REG_IN1  [0:`PIPE_STAGE-1];
    logic   signed  [`Y_WIDTH-1:0] Y_REG_OUT1 [0:`PIPE_STAGE-1];
